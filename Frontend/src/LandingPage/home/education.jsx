    ...
    return ( 
        <div className='container mt-5 mb-5'>
            ...
            <div className="row">
                ...
                <a href="#" style={{textDecoration:"none"}}> Varsity <i class="fa-solid fa-arrow-right ms-2"></i></a>
                ...
                <a href="#" style={{textDecoration:"none"}}> TradingQ&A  <i class="fa-solid fa-arrow-right ms-2"></i></a>
                </div>
