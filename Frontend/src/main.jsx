...
import Hero from "./LandingPage/products/hero.jsx"
import Hero1 from "./LandingPage/pricing/hero.jsx"
...
createRoot(document.getElementById('root')).render(
  ...
  <Routes>
    ...
    <Route path='/products' element={<Hero></Hero>}></Route>
    <Route path='/pricing' element={<Hero1></Hero1>}></Route>
