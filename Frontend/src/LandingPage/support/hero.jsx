    ...
    return (  
        ...
        <div className='row' style={{backgroundColor:"#387ed1", color:"white",width:"100%",paddingBottom:"2rem"}}>
            ...
            <div className="col-md-5 py-md-5 p-5 mt-5 mb-5">
                ...
                <input type="text" className='fs-6 mb-3 p-2 ps-4' name="" id="" style={{ height:"20%", width:"85%", border:"none",paddingLeft:"1rem" }} placeholder='Eg : how do i activate F&O, why is my order getting rejected......  ?'/>
            ...
            <h3 className=' me-5' style={{textAlign:"end"}}>Track Tickets</h3>
                ...
                <p className='fs-5'>1 . <a href="" className='fs-' style={{color:"white"}} > Current Takeovers and Delisting - December 2024
                </a></p>
